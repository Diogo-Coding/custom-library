  ...
  <div class="flex flex-col items-center justify-center px-[20%] pb-20 pt-8">
    ...
    <div class="flex flex-col items-center gap-6 justify-center">
      <div class="grid grid-cols-2 justify-center gap-4 max-w-[75%]">
        <ChipButton class="w-full" severity="primary" :ripple-color="true" v-ripple>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam enim mollitia vitae sint exercitationem, et
          quasi. Id amet consequuntur at, a eum provident sunt non inventore aliquid. Ea, dignissimos sunt.
          <div class="pt-4">
    ...
    <div class="flex flex-col items-center gap-6 justify-center">
      ...
      <div class="flex flex-wrap justify-center gap-4">
        ...
        <Button
          ...
          label="Button"
        />
        <Button icon="pi pi-search" severity="success" rounded variant="outlined" aria-label="Search" label="Button" />
        <Button icon="pi pi-user" severity="info" rounded variant="outlined" aria-label="User" label="Button" />
        <Button icon="pi pi-bell" severity="warn" rounded variant="outlined" aria-label="Notification" label="Button" />
      ...
      <div class="flex flex-wrap justify-center gap-4">
        ...
        <Button
          ...
          label="Button"
        />
        <Button icon="pi pi-heart" severity="help" variant="text" raised rounded aria-label="Favorite" label="Button" />
        <Button icon="pi pi-times" severity="danger" variant="text" raised rounded aria-label="Cancel" label="Button" />
        <Button icon="pi pi-star" severity="contrast" variant="text" raised rounded aria-label="Star" label="Button" />
      </div>
    ...
    <div class="flex flex-col gap-8 items-center justify-center">
      ...
      <div class="flex flex-col items-center justify-center gap-2">
        ...
        <Tag severity="danger" class="text-sm py-2 px-3">
